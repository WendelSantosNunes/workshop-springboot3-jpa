package educandoweb.example.course.config;
...
import educandoweb.example.course.entities.Payment;
import educandoweb.example.course.entities.Product;
import educandoweb.example.course.entities.User;
import educandoweb.example.course.entities.enums.OrderStatus;
import educandoweb.example.course.repositories.CategoryRepository;
import educandoweb.example.course.repositories.OrderItemRepository;
import educandoweb.example.course.repositories.OrderRepository;
import educandoweb.example.course.repositories.ProductRepository;
import educandoweb.example.course.repositories.UserRepository;
